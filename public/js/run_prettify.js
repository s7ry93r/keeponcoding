...
(function () {
  ...
  var URL_ROOT = "";
  var JS_PATH = URL_ROOT + "/js/";
  var CSS_PATH = URL_ROOT + "/css/";
  var SKIN_PATH = URL_ROOT + "/css/";

  //deprecated ... cuz of the modified paths above
  var LOADER_BASE_URL =
  ...
  for (var i = 0, n = skins.length; i < n; ++i) {
    skinUrls.push(SKIN_PATH
         + encodeURIComponent(skins[i]) + '.css');
  }
  skinUrls.push(CSS_PATH + 'prettify.css');
